...
@Component({
  selector: 'app-vendas-report',
  templateUrl: './vendas-report.component.html',
  styleUrls: ['./vendas-report.component.css']
})
export class VendasReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.chart = new Chart('bar', {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Comparação entre 2018 e 2019'
        },
      },
      data: {
